...
import 'package:cab_rider/helpers/requesthelper2.dart';
...
class PredictionTile extends StatelessWidget {
  ...
  void getPlaceDetails(String placeID, context) async {
    ...
    if(response['status'] == 'OK'){
      ...
      print('this is place:'+thisPlace.placeName);
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                        ...
                        children: <Widget>[
                          Text(prediction.mainText!=null?prediction.mainText:'No Results',overflow: TextOverflow.ellipsis,maxLines:1,style: TextStyle(fontSize: 16),),
                          SizedBox(height: 2,),
                          Text(prediction.secondaryText!=null?prediction.secondaryText:'...',overflow: TextOverflow.ellipsis,maxLines:1,style: TextStyle(fontSize: 12,color: BrandColors.colorDimText),),
